...
INSERT INTO public.author(id, first_name, last_name, version) VALUES (1, 'Thorben', 'Janssen', 0);
INSERT INTO public.author(id, first_name, last_name, version) VALUES (2, 'Steve', 'Ebersole', 0);

INSERT INTO public.book(id, title, version) VALUES (1, 'Hibernate Tips - More than 70 solutions to common Hibernate problems', 0);

INSERT INTO public.book_authors(books_id, authors_id) VALUES (1, 1);
INSERT INTO public.book_authors(books_id, authors_id) VALUES (1, 2);